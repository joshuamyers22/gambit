...
| P1.7 | Whole-contract target construction, buffering, and risk rechecks | P0.7, P0.8, existing sizing/FX/covariance APIs | Quant/execution owner | Before executing portfolio-level risk targets through a supported adapter | Implementation complete 2026-09-13; point-in-time conversion, rounding, buffering, required-reduction overrides, achieved-risk recomputation, shared admission, and a pending-aware Strategy adapter have representative evidence; `P1_7_SIGNOFF.md` is ready and quant/execution-owner approval is pending |
