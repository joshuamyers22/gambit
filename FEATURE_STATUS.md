...
| Cost and turnover diagnostics | Experimental; immutable built-in fill diagnostics retain pre-cost reference, modeled slippage/impact, rounding, execution price, model identity, and signed monetary effect; explicitly attributed incremental P&L and trades reconcile gross/net results, charges, turnover, and missing evidence without double counting | P2.4 repeatable sensitivity sweeps, buffered comparisons, representative evidence, and quant/analytics-owner approval |
