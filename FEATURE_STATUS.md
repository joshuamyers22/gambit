...
| Cost and turnover diagnostics | Experimental; explicitly attributed incremental P&L and trades reconcile gross/net results, signed fees/commission, traded notional, and capital-normalized turnover by period/instrument/rule without double-counting fill-price slippage | P2.4 immutable pre-cost execution diagnostics, slippage/impact attribution, repeatable sensitivity sweeps, representative evidence, and quant/analytics-owner approval |
