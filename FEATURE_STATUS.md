...
| Walk-forward experiment evaluation | Experimental; owned chronological splits, training-only generic/covariance/tail-risk adapters, and an existing-optimizer adapter isolate fitting, validation selection, purge gaps, and held-out scoring | P1.6 forecast-scalar integration, persisted experiment evidence/OOS equity, and quant/research-owner approval |
