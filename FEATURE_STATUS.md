...
| Executable portfolio targets | Experimental; base-currency exposures convert through owned price timestamps, contract multipliers, FX, and explicit whole-lot rounding into detached incremental proposals that reserve current and pending positions | P1.7 no-trade buffering, post-rounding risk/constraint rechecks, supported risk admission, representative evidence, and quant/execution-owner approval |
| Cost and turnover diagnostics | Experimental; immutable fill diagnostics and reconciled reports retain cost/turnover attribution without double counting; deterministic sensitivity cases record canonical assumptions, seeds, input/strategy/case fingerprints, finite comparable outcomes, and observed paired differences | P1.7 executable buffering, P2.4 representative cost/participation and buffered comparison evidence, and quant/analytics-owner approval |
