...
| Forecast scaling and combination | Experimental; Polars stages retain raw/scaled/capped values, weights, rule availability, and contributions; historical scalars plus inverse-volatility weights, empirical correlation, and bounded diversification fit only through a declared cutoff | P2.3 durable contribution evidence and quant/research-owner approval |
