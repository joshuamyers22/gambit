...
| Executable portfolio targets | Experimental implementation complete; base-currency exposures convert through owned price timestamps, contract multipliers, FX, explicit whole-lot rounding, and no-trade bands; required reductions override buffering but still pass shared admission, and the supported Strategy rule adapter reserves live pending orders before final re-admission | P1.7 quant/execution-owner approval using `P1_7_SIGNOFF.md` |
